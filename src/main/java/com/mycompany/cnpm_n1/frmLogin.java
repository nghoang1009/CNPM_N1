...
public class frmLogin extends JFrame {
    ...
    private final String DB_URL = "jdbc:mysql://localhost:3306/QL_SinhVienKTX";
    ...
    private void Login() {
        ...
        try {
            String sql = "SELECT id AS maTK, ten_dang_nhap AS tenTK, vai_tro_id AS chucVu " +
            ...
            if (rs.next()) {
                ...
                String chucVuText;
                if (chucVu.equals("1")) chucVuText = "Admin";
                else if (chucVu.equals("2")) chucVuText = "Nhân viên";
                else chucVuText = "Sinh viên";
